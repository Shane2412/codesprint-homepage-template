<?= form_open('Buyers/update_Demands'); ?>
<div class="container">
     ...
     <div class="panel panel-heading">
       <h1 class="animated bounceInDown" style="color:white; text-align:center;"> Edit Demands  <h1>
     </div>
     <div class="form-group">
	 <input type="hidden" name="oid" value="<?= $demands['oid']; ?>">
     ...
     <div class="col-lg-3">
     <h4> Quantity: </h4>
     <input class="form-control" type="number" name="order_quantity" placeholder="<?= $demands['order_quantity'];?>">
     <br>
     </div>
     ...
     <h4> Start Date: </h4>
     <input class="form-control" type="date" name="start_date_of_order" placeholder="<?= $demands['start_date_of_order'];?>"> </textarea>
     <br>
     
     <h4> End Date: </h4>
     <input class="form-control" type="date" name="end_date_of_order" placeholder="<?= $demands['end_date_of_order'];?>"> </textarea>
     <br>
