...
<html>
<head>
	<title>Farmers Crop Inventory</title>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <form data-toggle="validator" action="" method="put">
                ...
                <div class="form-group">
                    <label class="control-label" for="title">crop_max_count:</label>
                    <textarea name="description" class="form-control" data-error="Please enter description." required></textarea>
                    <div class="help-block with-errors"></div>
                </div>
                
                <div class="form-group">
                    <label class="control-label" for="title">produced_date:</label>
                    <textarea name="description" class="form-control" data-error="Please enter description." required></textarea>
                    <div class="help-block with-errors"></div>
                </div>
                
                <div class="form-group">
                    <label class="control-label" for="title">estimate_date:</label>
                    <textarea name="description" class="form-control" data-error="Please enter description." required></textarea>
                    <div class="help-block with-errors"></div>
                </div>
...
<script src="/js/crop-ajax.js"></script> 
